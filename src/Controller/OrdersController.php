...
final class OrdersController extends AbstractController
{
    ...
    SessionInterface $sessionInterface, ProductRepository $productRepository): Response
    {
        $this->denyAccessUnlessGranted('ROLE_USER','Accès refusé');
        $order = new Orders();
    ...
    public function show($id, OrdersDetailsRepository $ordersDetailsRepository,
    OrdersRepository $ordersRepository): Response
    {
        $orders = new Orders();
    ...
    public function by($id, OrdersRepository $ordersRepository,
